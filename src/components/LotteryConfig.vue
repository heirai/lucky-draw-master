<template>
  ...
  >
    <div class="c-LotteryConfigtitle" slot="title">
      ...
      <el-button size="mini" @click="addLottery">追加</el-button>
    ...
    <div class="container">
      <el-form ref="form" :model="form" size="mini">
        <el-form-item label="抽選タイトル">
          <el-input v-model="form.name"></el-input>
        </el-form-item>
        <el-form-item label="総抽選人数">
          <el-input
            type="number"
            v-model="form.number"
            :min="1"
    ...
    >
      <div class="add-title" slot="title">賞品を追加</div>
      <el-form ref="newLottery" :model="newLottery" size="mini">
        <el-form-item label="賞品名">
